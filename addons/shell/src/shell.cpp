...
namespace {
	...
	void lua_pushlasterr(lua_State* L, const wchar_t* lpszFunction)
	{
		DWORD dw;
		size_t iLenMsg = 0;
	...
	void pushFFTime(lua_State* L, FILETIME* ft)
	{
		SYSTEMTIME st;
