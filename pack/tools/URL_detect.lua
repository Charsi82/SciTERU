...
local lib = require'lpeg'
local libver = type(lib.version) == "string" and lib.version or lib.version() -- "Lpeg 1.1"
libver = tonumber(string.match(libver, "%d%.%d+")) or 0
assert(libver>=0.10, 'LPEG 0.10 or newer needed')
