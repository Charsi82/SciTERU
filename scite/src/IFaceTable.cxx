...
constexpr int IFaceTable::functionCount = _countof(ifaceFunctions);

const IFaceConstant *const IFaceTable::constants = ifaceConstants;
constexpr int IFaceTable::constantCount = _countof(ifaceConstants);

const IFaceProperty *const IFaceTable::properties = ifaceProperties;
constexpr int IFaceTable::propertyCount = _countof(ifaceProperties);
